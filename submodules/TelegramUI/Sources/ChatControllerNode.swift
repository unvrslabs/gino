...
class ChatControllerNode: ASDisplayNode, ASScrollViewDelegate {
    ...
    // Gino: due moduli diversi definiscono una EmptyInputView pubblica identica
    ...
    private final class GinoEmptyInputView: UIView, UIInputViewAudioFeedback {
        var enableInputClicksWhenVisible: Bool {
            return true
        }
    }

    private let emptyInputView = GinoEmptyInputView()

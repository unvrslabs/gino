...
if [ "$ARCH" = "arm64" ]; then
    # Il file originale scrive a mano /Applications/Xcode.app. Su un Mac dove
    # Xcode sta altrove (per esempio Xcode-beta.app) il compilatore non trova
    # la SDK e si ferma su stdlib.h. Stessa cura gia' usata piu' sotto per il
    # simulatore: si copia il file e si sostituisce col percorso vero.
